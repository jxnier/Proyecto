...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-10-2024 a las 16:18:13
...
(5, 'mp@unibarranquilla.edu.co', 'hoy me siento feliz', '2024-09-24 22:59:34'),
(6, 'juan.perez@unibarranquilla.edu.co', 'Hoy dormi con mucho frio.', '2024-09-25 07:06:23'),
(7, 'fafruto@unibarranquilla.edu.co', 'no me mate hoy', '2024-09-25 11:08:26'),
(8, 'andres@unibarranquilla.edu.co', 'hoy me siento feliz', '2024-09-25 14:15:27'),
(10, 'andres@unibarranquilla.edu.co', 'gane el examen', '2024-09-25 14:17:18');
...
(24, 'Margaret Pal', 'mp@unibarranquilla.edu.co', 'Marga123@', 'TI', 122345678, NULL, 'Depresion', NULL),
(25, 'fabio fruto', 'fafruto@unibarranquilla.edu.co', 'Jo12345*', 'CC', 1001944057, NULL, 'Depresion', NULL),
(26, 'Andres Juan Mendez Arco', 'andres@unibarranquilla.edu.co', 'Andres123*', 'CC', 1024597562, NULL, 'Bipolar Type-2', NULL);
...
(13, 'Psico logo', 'psico@unibarranquilla.edu.co', 'Psico123@', 234567654, NULL),
(14, 'Julia Roberts', 'Julia@unibarranquilla.edu.co', 'Julia123@', 10010010, NULL),
(15, 'Regina Andrea Rodriguez', 'rarodriguez@unibarranquilla.edu.co', 'Regi123*', 82564998, NULL),
(16, 'Julian Alfonso Correa Ramos', 'julian@unibarranquilla.edu.co', 'Julian123*', 1025966948, NULL);
...
(18, 13, 'Traer historial clinico ', 'suriofdbjl', '2024-09-25 03:56:51', 'evento'),
(19, 16, 'Beneficios de la meditacion', 'Medite amigo.', '2024-09-25 19:20:50', 'consejo');
...
(5, 16, 13, 'traer borrador', 'syuhxm', 0),
(6, 26, 16, 'Traer escrito de tu infan', 'Traerlo', 1);
...
--
ALTER TABLE `psicologo`
  MODIFY `id_psicologo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `publicacion`
--
ALTER TABLE `publicacion`
  MODIFY `id_publicacion` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
